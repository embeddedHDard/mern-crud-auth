...
export const registerRequest = (user) => axios.post(`/register`, user); //vas a recibir un usuario que lo vas a pasar en el request body
export const loginRequest = (user) => axios.post(`/login`, user); //vas a recibir un usuario que lo vas a pasar en el request body
